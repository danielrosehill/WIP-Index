...
[![WIP](https://img.shields.io/badge/Focus-Work%20In%20Progress-yellow?style=for-the-badge)](https://github.com/danielrosehill/WIP-Index)

An index of work-in-progress repositories — projects at various stages of development, from early ideas and planning notes to partially built tools awaiting further work.

## Related Indexes

- [Ideas Index](https://github.com/danielrosehill/Ideas-Index) — Idea and concept repositories
- [Experiments & Evaluations Index](https://github.com/danielrosehill/Experiments-And-Evaluations-Index) — Experiments and evaluations
- [AI Projects Index](https://github.com/danielrosehill/AI-Projects-Index) — AI project repositories

---

## Active Development

Projects currently being built or with clear next steps.

| Project | Description | Action | Links |
|---------|-------------|--------|-------|
| **Geopol Forecaster POC** | Experimental prediction analysis for real world events (Iran-Israel) | Continue building | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Geopol-Forecaster-POC) |
| **Claudify This** | Slash command for asking Claude to proactively spawn Claude "helper" elements in a repo | Extend | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claudify-This) |
...
Projects to experiment with or evaluate feasibility.

| Project | Description | Notes | Links |
|---------|-------------|-------|-------|
| **Claude AI Conference** | AI experiment: panel + TTS, mini conference/symposium | To try | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-AI-Conference) |
| **Claude Change My View** | CMV with AI (pattern/template) | To try (MWP Podcast) | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Change-My-View) |
| **Code Tutor Agent Model** | Basic config/idea for an AI agent(s) to guide rather than "do" | To try | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Code-Tutor-Agent-Model) |
| **Claude Think Tank** | Model repository for a think tank composed of AI agents focused on research and policy proposals | To explore | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Think-Tank) |

---

## Needs GUI

Projects that should be modeled or rebuilt as graphical interfaces.

| Project | Description | Links |
|---------|-------------|-------|
| **Claude Redaction And Obfuscation** | Claude Code workspace for document redaction and identity obfuscation — supporting whistleblowing, source protection, defamation defense, and anonymous publishing | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Redaction-And-Obfuscation) |
| **Custom License Creator** | AI tool to create a bespoke set of licensing terms for a project | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Custom-License-Creator) |
| **Github Repo Pruner** | Helps to discard old repositories from a local filesystem (for Linux) | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Github-Repo-Pruner) |
| **Hardware Probe Agent Template** | AI agent template: uses SSH MCP to connect to remotes, probes hardware, generates a structured report | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Hardware-Probe-Agent-Template) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Agent Junction** | Ephemeral agent-to-agent communication relay for agentic CLIs (localhost or intra-LAN). MCP | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Agent-Junction) |
| **AI Agent UN** | Experimental implementation of a model real life political body populated by representative AI agents | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/AI-Agent-UN) |
| **Claude Agent Picker Pattern** | Pattern/idea for the "too many subagents" problem | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Agent-Picker-Pattern) |
| **Panel Of Claude** | Exploratory Claude model: multiple agents mimicking a panel debate | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Panel-Of-Claude) |
| **Peace In The Middle East** | WIP — Multi-agentic geopolitical simulation ideating problem-solving and bridge-building in the Middle East | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Peace-In-The-Middle-East) |
| **Vibe Code And Learn** | A model multi-agent config for agentic code-gen with an educational "loop" | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Vibe-Code-And-Learn) |
| **You Might Like Agent** | CLI that generates batches of curated recommendations for movies, books, podcasts, etc | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/You-Might-Like-Agent) |
| **Lashon Hara Chatbot** | Prototype chat UI for lashon hara Q&A | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Lashon-Hara-Chatbot) |
| **JLM Shelter Agent** | AI agent for JLM Shelter app/project | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/JLM-Shelter-Agent) |
| **End Of Day Worklog** | Agent model for taking daily snapshots of work progress | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/End-Of-Day-Worklog) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Agentic AI Architecture Visualisation** | Framework-agnostic data model and visualizations mapping the moving pieces of agentic AI systems | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Agentic-AI-Architecture-Visualisation) |
| **AI Model Manager** | Planning/WIP repo for AI model manager | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/AI-Model-Manager) |
...
## Claude Code Extensions & Patterns

| Project | Description | Links |
|---------|-------------|-------|
| **Claude Linux Desktop Manager** | WIP/Plan: extension of slash commands to an actual GUI/program | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Linux-Desktop-Manager) |
| **Claude OS Sync Agent** | Idea — using Claude Code in place of Ansible for cross-device updating/sync | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-OS-Sync-Agent) |
| **Claude Rescue** | WIP/Plan/Idea: System recovery/rescue utility that seeds Claude Code installation for AI-assisted repair from TTYs/shell | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-Rescue) |
| **Claude LAN Manager 0126** | LAN management GUI | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Claude-LAN-Manager-0126) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Dictation Macropad** | Plan/key allocation for a macropad optimised for heavy daily dictation workflows | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Dictation-Macropad) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Jerusalem Tech Ecosystem** | Resource list / mapping | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Jerusalem-Tech-Ecosystem) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Video Edit Instructions** | Holding repo. Idea: screencast -> editing instructions -> AI agent | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Video-Edit-Instructions) |
...
| Project | Description | Links |
|---------|-------------|-------|
| **Github Explorer** | WIP/Notes | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Github-Explorer) |
| **Github Star Organiser** | WIP — system for managing things you star on Github | [![View Repo](https://img.shields.io/badge/View-Repo-blue?style=flat-square&logo=github)](https://github.com/danielrosehill/Github-Star-Organiser) |
